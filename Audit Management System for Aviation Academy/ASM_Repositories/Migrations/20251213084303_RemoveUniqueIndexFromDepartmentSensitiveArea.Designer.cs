...
namespace ASM_Repositories.Migrations
{
    ...
    [Migration("20251213084303_RemoveUniqueIndexFromDepartmentSensitiveArea")]
    partial class RemoveUniqueIndexFromDepartmentSensitiveArea
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AccessGrant", b =>
                {
                    ...
                    b.HasKey("GrantId")
                        .HasName("PK__AccessGr__90E9FF8A12345678");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditAssignment", b =>
                {
                    ...
                    b.HasKey("AssignmentId")
                        .HasName("PK__AuditAss__32499E577880D709");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditChecklistTemplateMap", b =>
                {
                    b.Property<Guid>("AuditId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("AuditID");
                    ...
                    b.HasKey("AuditId", "TemplateId");

                    b.HasIndex("AssignedBy");

                    b.HasIndex("TemplateId");

                    b.ToTable("Audit_ChecklistTemplate_Map", "ams");
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditPlanAssignment", b =>
                {
                    b.Property<Guid>("AssignmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("AssignmentId")
                        .HasName("PK__AuditPla__32499E77504F35C6");

                    b.HasIndex("AssignBy");

                    b.HasIndex("AuditorId");

                    b.ToTable("AuditPlan_Assignment", (string)null);
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.ChecklistItemNoFinding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("AuditChecklistItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateOnly?>("DateOfCompliance")
                        .HasColumnType("date");
                    ...
                    b.Property<TimeOnly?>("TimeOfCompliance")
                        .HasColumnType("time");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Checklis__3214EC07C9816FC6");

                    b.HasIndex("AuditChecklistItemId");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("WitnessId");

                    b.ToTable("ChecklistItem_NoFinding", "ams");
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.DepartmentSensitiveArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("SensitiveAreas")
                        .IsRequired()
                        .HasMaxLength(2147483647)
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id")
                        .HasName("PK__Departme__3214EC07A1B2C3D4");
                    ...
                    b.ToTable("DepartmentSensitiveArea", "ams");
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.SensitiveAreaLevel", b =>
                {
                    b.Property<string>("Level")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasKey("Level")
                        .HasName("PK_SensitiveAreaLevel");

                    b.ToTable("SensitiveAreaLevel", "ams");
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AccessGrant", b =>
                {
                    ...
                    b.HasOne("ASM_Repositories.Entities.UserAccount", "Auditor")
                        .WithMany()
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditAssignment", b =>
                {
                    b.HasOne("ASM_Repositories.Entities.Audit", "Audit")
                        .WithMany("AuditAssignments")
                        .HasForeignKey("AuditId")
                        .IsRequired()
                        .HasConstraintName("FK__AuditAssi__Audit__634EBE90");

                    b.HasOne("ASM_Repositories.Entities.UserAccount", "Auditor")
                        .WithMany("AuditAssignments")
                        .HasForeignKey("AuditorId")
                        .IsRequired()
                        .HasConstraintName("FK__AuditAssi__Audit__65370702");

                    b.HasOne("ASM_Repositories.Entities.Department", "Dept")
                        .WithMany("AuditAssignments")
                        .HasForeignKey("DeptId")
                        .IsRequired()
                        .HasConstraintName("FK__AuditAssi__DeptI__6442E2C9");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditChecklistTemplateMap", b =>
                {
                    b.HasOne("ASM_Repositories.Entities.UserAccount", "AssignedByNavigation")
                        .WithMany("AuditChecklistTemplateMaps")
                        .HasForeignKey("AssignedBy")
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditPlanAssignment", b =>
                {
                    b.HasOne("ASM_Repositories.Entities.UserAccount", "AssignByNavigation")
                        .WithMany("AuditPlanAssignmentAssignByNavigations")
                        .HasForeignKey("AssignBy")
                        .IsRequired()
                        .HasConstraintName("FK__AuditPlan__Assig__1D7B6025");

                    b.HasOne("ASM_Repositories.Entities.UserAccount", "Auditor")
                        .WithMany("AuditPlanAssignmentAuditors")
                        .HasForeignKey("AuditorId")
                        .IsRequired()
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.ChecklistItemNoFinding", b =>
                {
                    b.HasOne("ASM_Repositories.Entities.AuditChecklistItem", "AuditChecklistItem")
                        .WithMany("ChecklistItemNoFindings")
                        .HasForeignKey("AuditChecklistItemId")
                        .IsRequired()
                        .HasConstraintName("FK__Checklist__Audit__22401542");

                    b.HasOne("ASM_Repositories.Entities.UserAccount", "CreatedByNavigation")
                        .WithMany("ChecklistItemNoFindingCreatedByNavigations")
                        .HasForeignKey("CreatedBy")
                        .IsRequired()
                        .HasConstraintName("FK__Checklist__Creat__214BF109");

                    b.HasOne("ASM_Repositories.Entities.UserAccount", "Witness")
                        .WithMany("ChecklistItemNoFindingWitnesses")
                        .HasForeignKey("WitnessId")
                        .IsRequired()
                        .HasConstraintName("FK__Checklist__Witne__2057CCD0");

                    b.Navigation("AuditChecklistItem");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.DepartmentSensitiveArea", b =>
                {
                    ...
                    b.HasOne("ASM_Repositories.Entities.SensitiveAreaLevel", "LevelNavigation")
                        .WithMany("DepartmentSensitiveAreas")
                        .HasForeignKey("Level")
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.Audit", b =>
                {
                    ...
                    b.Navigation("AuditAssignments");

                    b.Navigation("AuditChecklistItems");

                    b.Navigation("AuditChecklistTemplateMaps");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.AuditChecklistItem", b =>
                {
                    b.Navigation("ChecklistItemNoFindings");
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.SensitiveAreaLevel", b =>
                {
                    b.Navigation("DepartmentSensitiveAreas");
                });
            ...
            modelBuilder.Entity("ASM_Repositories.Entities.UserAccount", b =>
                {
                    ...
                    b.Navigation("AuditPlanAssignmentAssignByNavigations");

                    b.Navigation("AuditPlanAssignmentAuditors");

                    b.Navigation("AuditTeams");

                    b.Navigation("Audits");

                    b.Navigation("ChecklistItemNoFindingCreatedByNavigations");

                    b.Navigation("ChecklistItemNoFindingWitnesses");
